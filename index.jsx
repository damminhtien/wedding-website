    ...
    <section id="home" className="relative overflow-hidden bg-[#f8f3e8] pt-16 sm:pt-20 lg:min-h-screen">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-4 py-8 sm:px-5 sm:py-12 lg:min-h-[calc(100vh-5rem)] lg:grid-cols-[0.9fr_1.1fr]">
        <motion.div initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }} className="max-w-3xl text-center lg:text-left">
          ...
          <h1 className="inline-block whitespace-nowrap rounded-md border border-[#d8c48b]/70 bg-[#fffaf0]/82 px-3 py-1 text-[clamp(1.8rem,6.8vw,3.9rem)] font-bold italic tracking-[0.005em] text-[#142217] shadow-2xl shadow-[#42553d]/16 backdrop-blur-md sm:px-4 sm:tracking-[0.015em] lg:tracking-[0.025em]" style={{ fontFamily: '"Fraunces", "Cormorant Garamond", Georgia, serif', fontVariationSettings: '"SOFT" 75, "WONK" 1', WebkitTextStroke: "0.3px rgba(255, 250, 240, 0.9)", textShadow: "0 3px 20px rgba(255, 250, 240, 1), 0 3px 6px rgba(20, 34, 23, 0.34)" }}>Lễ Thành Hôn</h1>
